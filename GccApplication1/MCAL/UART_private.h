...
#define UDR_REG 					*((volatile u8*)0x2C)//Da ele b2ra mno el RX(higher bits) w nb3atlo el TX(lower bits)
...
#define UMSEL_BIT   				6 //synchronous or asynchronus
...
#define UXSZ2_BIT					2 //Select when 1 (9-bit mode)
